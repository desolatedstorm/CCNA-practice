...
192.168.23.2 1 FULL/DR 00:00:33 192.168.13.2 GigabitEthernet0/0/1  
192.168.23.1 1 FULL/DR 00:00:30 192.168.12.2 GigabitEthernet0/0/0 */
...
L 192.168.1.1/32 is directly connected, GigabitEthernet0/1/0 */
O 192.168.2.0/24 [110/2] via 192.168.12.2, 00:32:33, GigabitEthernet0/0/0
O 192.168.3.0/24 [110/2] via 192.168.13.2, 00:31:48, GigabitEthernet0/0/1 /* 192.168.12.0/24 is variably subnetted, 2 subnets, 2 masks  
C 192.168.12.0/30 is directly connected, GigabitEthernet0/0/0  
L 192.168.12.1/32 is directly connected, GigabitEthernet0/0/0  
192.168.13.0/24 is variably subnetted, 2 subnets, 2 masks  
C 192.168.13.0/30 is directly connected, GigabitEthernet0/0/1  
L 192.168.13.1/32 is directly connected, GigabitEthernet0/0/1  
192.168.23.0/30 is subnetted, 1 subnets */
O 192.168.23.0/30 [110/2] via 192.168.13.2, 00:31:38,GigabitEthernet0/0/1 
[110/2] via 192.168.12.2, 00:31:38, GigabitEthernet0/0/0
...
Maximum hold time for LSA throttle 5000 msecs  
...
Area ranges are  
Number of LSA 6. Checksum Sum 0x046F75  
...
Gi0/1/0 1 0 192.168.1.1/24 1 DR 0/0  
Gi0/0/1 1 0 192.168.13.1/30 1 BDR 1/1  
Gi0/0/0 1 0 192.168.12.1/30 1 BDR 1/1 */

for more detail: show ip ospf interface
```
...
// e.g access-list 1 permit 192.168.1.0 0.0.0.255
```
...
// e.g ip nat pool my_pool 203.149.210.226 203.149.210.230 netmask 255.255.255.248
```
...
// e.g ip nat inside source list 1 pool my_pool
```
...
```c
DHCP(config)# ip dhcp excluded-address 1st-ip-addr last-ip-addr
...
/* command to view DHCP address leases */
  
show ip dhcp server 
/* statistics command to view the DHCP pool statistics and message activity */

show ip dhcp pool 
/* view the DHCP pool settings */
```
...
```c
SW1# show run interface g1/0/3  
/*
Building configuration...  
Current configuration : 70  
bytes !  
...
/* note:
The command opton root secondary will auto-configure itself with a priority  
...
State is Active  
2 state changes, last state change 00:00:30  
...
Standby router is 192.168.10.2, priority 100 (expires in 11.120 sec)  
